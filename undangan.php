...
<head>
	...
	<title>The Wedding of Yuni & Arif</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box fadeInUp animated-fast">
						<img src="images/88.png" alt="" class="couple-main2">
					</div>
				</div>
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
						<h1 style="color:yellow;">Undangan</h1>
			...
			<div class="couple-wrap animate-box">
				<div class="couple-half">
					...
					<div class="desc-groom">
						<h3>Yuni Rakhmawati Rahayuningsih</h3>
						<p><span style="color: #bf9b73">Putri dari</span><br>
							<span class="parents-font">Bapak Soedibyo Yuwono (Alm)</span>
							<br>
							<span class="parents-font">Ibu Mukminatun</span>
						</p>
				...
				<div class="couple-half">
					...
					<div class="desc-bride">
						...
						<p><span style="color: #bf9b73">Putra dari</span><br>
							<span class="parents-font">Bapak Syahid (Alm)</span>
							<br>
							<span class="parents-font">Ibu Zuriah</span>
						</p>
					...
					<div class="col-md-6 col-sm-6 text-center">
						<div class="event-wrap animate-box">
							...
							<div class="event-col">
								...
								<span>Senin</span>
								<span class="tanggal">10 Juli 2023</span>
							</div>
							<p style="font-family: 'Courgette', Arial, serif">Alamat : Dk. Wonosari Ds. Tahunan RT 03 RW 05 Tahunan Jepara</p>

							<a href="https://goo.gl/maps/6mchSnafk1yantiL9" target="_blank"
		...
		<div class="container">
			...
			<div class="row copyright animate-box">
				<div class="col-md-12 text-center">
					...
					<img src="images/half circle flower-500.png" width="150" height="150">
					<br>
					<h1 style="font-family: 'Satisfy', Arial, serif">Yuni R.R. (BPKAD) & Arif Himawan</h1>
					<p>
